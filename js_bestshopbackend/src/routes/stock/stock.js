...
const get_shop = require("../../controllers/stock/dashboard");
const get_user = require("../../controllers/stock/dashboard");
...
router.get("/shop-count", get_shop.get_shop_count);
router.get("/shop-user", get_user.get_shop_user);
